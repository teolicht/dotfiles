...
function update_spaces()
    for i, workspace in ipairs(workspaces) do sbar.exec("aerospace list-windows --workspace " .. i .. " --format '%{app-name}' --json ", function(apps)
        local icon_line = ""
        local no_app = true
...
for i, workspace in ipairs(workspaces) do
    ...
    local space = sbar.add("item", "item." .. i, {
        icon = {
            ...
            color = settings.items.empty_color,
            highlight_color = settings.items.filled_color,
            highlight = selected
        },
        label = {
        ...
        background = {
            ...
            border_color = selected and settings.items.border_highlight_color or settings.items.border_default_color;
        },
        popup = {
            background = {
                border_width = 5,
...
--     },
--     background = {
--         color = colors.with_alpha(colors.light_gray, 0.0),
